<?php
class Cammino_Realtimereports_Model_Mysql4_Region_Collection extends Mage_Sales_Model_Mysql4_Report_Collection_Abstract
{
    ...
    protected function _initSelect()
    {
        if (!$this->isTotals()) {
            ...
            $this->getSelect()->group('sales_flat_order_address.region');
