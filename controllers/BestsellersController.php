<?php
class Cammino_Realtimereports_BestsellersController extends Mage_Adminhtml_Controller_Action
{
	...
	{
		$fileName = 'sales.csv';
		$grid = $this->getLayout()->createBlock('realtimereports/bestsellers_grid');
