<?php
class Cammino_Realtimereports_CustomersController extends Mage_Adminhtml_Controller_Action
{
	...
	{
		$fileName = 'sales.csv';
		$grid = $this->getLayout()->createBlock('realtimereports/customers_grid');
